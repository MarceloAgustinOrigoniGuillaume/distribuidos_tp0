...
### Explicacion
Simplemente se mapeo con el volumes el archivo a /usr/config.yaml y config.ini y luego el container puede acceder sin problemas. Solo se mapeo los archivos por medio del docker compose.
