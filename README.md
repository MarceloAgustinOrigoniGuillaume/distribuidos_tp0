...
Se agrego solo logica de recepcion de datos un wrapper ServerProtocol que resuelve el short read y permite leer Int, u16 y String. De forma binaria, los string mandando primero el largo de la string y luego los bytes.

### Cliente

Se pasa por env variables la configuracion de la apuesta. Se cuenta con ClientProtocol que encapsula la logica de serializado y resuelve el short send. Se tiene un DTO PersonBet.
